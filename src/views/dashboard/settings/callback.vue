  ...
  export default {
    ...
    methods: {
      getCallbackShopify () {
        ...
        axios.get(process.env.VUE_APP_HOST_API + '/shopify/callback?shop=' + shop + '&hmac=' + hmac + '&code=' + code + '&state=' + state + '&token=' + auth).then(response => {
      ...
      importCustomer () {
        ...
        axios.get(process.env.VUE_APP_HOST_API + '/shopify/importCustomer?shop=' + shop + '&tokenShopify=' + tokenShopify + '&token=' + auth)
      },
    },
  }
</script>

  ...
  export default {
    ...
    methods: {
      getCallbackShopify () {
        ...
        axios.get('https://dropstationapi.heroku.com/shopify/callback?shop=' + shop + '&hmac=' + hmac + '&code=' + code + '&state=' + state + '&token=' + auth).then(response => {
      ...
      importCustomer () {
        ...
        axios.get('https://dropstationapi.heroku.com/shopify/importCustomer?shop=' + shop + '&tokenShopify=' + tokenShopify + '&token=' + auth)
      },
    },
  }
</script>
